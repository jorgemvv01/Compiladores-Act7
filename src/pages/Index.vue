    ...
    <div class="row justify-content-center q-mt-md">
      <div class="col-12">
        <q-card class="my-card">
          <q-tabs v-model="tab" class="text-white bg-light-blue-6">
  ...
  methods: {
    notificar(variant, message) {
      this.$q.notify({
        ...
        color: variant,
        multiLine: true,
        avatar: "https://img.icons8.com/color/48/000000/futurama-bender.png",
        actions: [
          {
            label: "Ok",
            color: "white",
    ...
    validarError(error) {
      ...
      this.notificar(
        "negative",
        `Hubo un error, revise en la ventana errores`
      );
