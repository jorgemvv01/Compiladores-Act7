...
import { DeclaracionMetodo } from './instrucciones/declaraciones/declaracion_metodo';
import { LlamadaMetodo } from './expresiones/llamada_metodo';
...
import { InstruccionSiempreq } from './expresiones/condicionales/instruccion_siempreq';
...
export class Ejecucion {
  ...
  recorrer(nodo: any): any {
    ...
    if (this.soyNodo('TIPO_IGUAL', nodo)) {
      switch (nodo.hijos.length) {
        case 1:
          return '=';
        case 2:
          if (nodo.hijos[0] == '#mas#') return '+=';
          if (nodo.hijos[0] == '#menos#') return '-=';
      }
    }
    ...
    if (this.soyNodo('DECLARACION_METODO', nodo)) {
      switch (nodo.hijos.length) {
        ...
        case 7: {
          ...
          return new DeclaracionMetodo(nodo.linea, id, instrucciones);
        }
        ...
        case 8: {
          ...
          return new DeclaracionMetodo(nodo.linea, id, instrucciones, TIPO_DATO.VOID, lista_parametros);
        }
        ...
        case 9: {
          ...
          return new DeclaracionMetodo(nodo.linea, id, instrucciones, tipo_return);
        }
        case 10: {
          ...
          //function id par_izq LISTA_PARAMETROS par_der dos_puntos TIPO_VARIABLE_NATIVA llave_izq INSTRUCCIONES llave_der
            ...
            const tipo_return = tipo_variable_nativa.tipo;
            const instrucciones = this.recorrer(nodo.hijos[8]);
            return new DeclaracionMetodo(nodo.linea, id, instrucciones, tipo_return, lista_parametros);
          }
        }
    ...
    if (this.soyNodo('INSTRUCCION_SIEMPREQ', nodo)) {
      switch (nodo.hijos.length) {
        ...
        case 1:
          ...
          return new InstruccionSiempreq(nodo.linea, [inst]);
        case 2:
          //IF ELSE
          if (this.soyNodo('SIEMPREQ', nodo.hijos[0]) && this.soyNodo('SIEMPREQN', nodo.hijos[1])) {
            ...
            return new InstruccionSiempreq(nodo.linea, [inst_siempreq, inst_siempreqn]);
          }
          //IF LISTA_ELSE_IF
          if (this.soyNodo('SIEMPREQ', nodo.hijos[0]) && this.soyNodo('LISTA_SIEMPREQN_SIEMPREQ', nodo.hijos[1])) {
            ...
            return new InstruccionSiempreq(nodo.linea, [inst_siempreq, ...lista_siempreqs]);
          }
        ...
        case 3:
          ...
          return new InstruccionSiempreq(nodo.linea, [inst_siempreq, ...lista_siempreqs, inst_siempreqn]);
      }
    }
    ...
    if (this.soyNodo('SIEMPREQ', nodo)) {
      ...
      const instrucciones = this.recorrer(nodo.hijos[5]);
      return new Siempreq(condicion, instrucciones);
    }
