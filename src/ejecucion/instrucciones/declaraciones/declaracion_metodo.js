...
exports.DeclaracionMetodo = void 0;
const error_1 = require("../../../arbol/error");
const errores_1 = require("../../../arbol/errores");
const metodo_1 = require("../../metodo");
const instruccion_1 = require("../../instruccion");
class DeclaracionMetodo extends instruccion_1.Instruccion {
    ...
    ejecutar(e) {
        ...
        e.setFuncion(new metodo_1.Metodo(this.id, this.instrucciones, this.tipo_return, this.lista_parametros));
    }
}
