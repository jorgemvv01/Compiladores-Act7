...
const declaracion_metodo_1 = require("./instrucciones/declaraciones/declaracion_metodo");
const llamada_metodo_1 = require("./expresiones/llamada_metodo");
...
const siempreq_1 = require("./siempreq");
const instruccion_siempreq_1 = require("./expresiones/condicionales/instruccion_siempreq");
...
class Ejecucion {
    ...
    recorrer(nodo) {
        ...
        if (this.soyNodo('INSTRUCCIONES', nodo)) {
            ...
            nodo.hijos.forEach((nodoHijo) => {
                if ( /* this.soyNodo('DECLARACION_VARIABLE', nodoHijo) ||  */this.soyNodo('DECLARACION_METODO', nodoHijo) || this.soyNodo('DECLARACION_TYPE', nodoHijo)) {
        ...
        if (this.soyNodo('EXP', nodo)) {
            switch (nodo.hijos.length) {
                ...
                case 2:
                    //menos EXP
                    if (nodo.hijos[0] == '#menos#' && this.soyNodo('EXP', nodo.hijos[1])) {
                    ...
                    //id mas_mas
                    if (nodo.hijos[1] == '#incr') {
                        const id = nodo.hijos[0];
                        return new mas_mas_1.MasMas(nodo.linea, id);
                    }
                    //id menos_menos
                    if (nodo.hijos[1] == '#desc') {
                        const id = nodo.hijos[0];
                        return new menos_menos_1.MenosMenos(nodo.linea, id);
                    }
                    //not EXP
                    if (nodo.hijos[0] == '#no#' && this.soyNodo('EXP', nodo.hijos[1])) {
                        const exp = this.recorrer(nodo.hijos[1]);
                        return new Not_1.Not(nodo.linea, exp);
                    }
                case 3:
                    //EXP mas EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#mas#' && this.soyNodo('EXP', nodo.hijos[2])) {
                    ...
                    //EXP menos EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#menos#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP por EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#por#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP div EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#div#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP mod EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#mod#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP potencia EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#pot#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP and EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#ademas#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
                    ...
                    //EXP or EXP
                    if (this.soyNodo('EXP', nodo.hijos[0]) && nodo.hijos[1] == '#oquizas#' && this.soyNodo('EXP', nodo.hijos[2])) {
                        const expIzq = this.recorrer(nodo.hijos[0]);
                        const expDer = this.recorrer(nodo.hijos[2]);
                        const linea = nodo.linea;
        ...
        //CONSOLE_LOG
        if (this.soyNodo('MUESTRA_LOG', nodo)) {
        ...
        //DECLARACION_FUNCION
        if (this.soyNodo('DECLARACION_METODO', nodo)) {
            switch (nodo.hijos.length) {
                //function id par_izq par_der llave_izq INSTRUCCIONES llave_der
                case 7: {
                    const id = nodo.hijos[1];
                    const instrucciones = this.recorrer(nodo.hijos[5]);
                    return new declaracion_metodo_1.DeclaracionMetodo(nodo.linea, id, instrucciones);
                }
                ...
                case 8: {
                    ...
                    return new declaracion_metodo_1.DeclaracionMetodo(nodo.linea, id, instrucciones, 5 /* VOID */, lista_parametros);
                }
                ...
                case 9: {
                    ...
                    return new declaracion_metodo_1.DeclaracionMetodo(nodo.linea, id, instrucciones, tipo_return);
                }
                case 10: {
                    ...
                    //function id par_izq LISTA_PARAMETROS par_der dos_puntos TIPO_VARIABLE_NATIVA llave_izq INSTRUCCIONES llave_der
                        ...
                        const tipo_return = tipo_variable_nativa.tipo;
                        const instrucciones = this.recorrer(nodo.hijos[8]);
                        return new declaracion_metodo_1.DeclaracionMetodo(nodo.linea, id, instrucciones, tipo_return, lista_parametros);
                    }
                }
        ...
        //LLAMADA_FUNCION
        if (this.soyNodo('LLAMADA_METODO', nodo)) {
            const id = nodo.hijos[0];
            switch (nodo.hijos.length) {
                //id par_izq par_der punto_coma
                case 4:
                    return new llamada_metodo_1.LlamadaMetodo(nodo.linea, id);
                //id par_izq LISTA_EXPRESIONES par_der punto_coma
                case 5:
                    //[EXP ...]
                    const lista_expresiones = this.recorrer(nodo.hijos[2]);
                    return new llamada_metodo_1.LlamadaMetodo(nodo.linea, id, lista_expresiones);
            }
        }
        //LLAMADA_FUNCION_EXP
        if (this.soyNodo('LLAMADA_METODO_EXP', nodo)) {
            const id = nodo.hijos[0];
            switch (nodo.hijos.length) {
                //id par_izq par_der
                case 3:
        ...
        //INSTRUCCION_IF
        if (this.soyNodo('INSTRUCCION_SIEMPREQ', nodo)) {
            switch (nodo.hijos.length) {
                //IF
                case 1:
                    const inst = this.recorrer(nodo.hijos[0]);
                    return new instruccion_siempreq_1.InstruccionSiempreq(nodo.linea, [inst]);
                case 2:
                    //IF ELSE
                    if (this.soyNodo('SIEMPREQ', nodo.hijos[0]) && this.soyNodo('SIEMPREQN', nodo.hijos[1])) {
                        const inst_siempreq = this.recorrer(nodo.hijos[0]);
                        const inst_siempreqn = this.recorrer(nodo.hijos[1]);
                        return new instruccion_siempreq_1.InstruccionSiempreq(nodo.linea, [inst_siempreq, inst_siempreqn]);
                    }
                    //IF LISTA_ELSE_IF
                    if (this.soyNodo('SIEMPREQ', nodo.hijos[0]) && this.soyNodo('LISTA_SIEMPREQN_SIEMPREQ', nodo.hijos[1])) {
                        const inst_siempreq = this.recorrer(nodo.hijos[0]);
                        const lista_siempreqs = this.recorrer(nodo.hijos[1]);
                        return new instruccion_siempreq_1.InstruccionSiempreq(nodo.linea, [inst_siempreq, ...lista_siempreqs]);
                    }
                //IF LISTA_ELSE_IF ELSE
                case 3:
                    const inst_siempreq = this.recorrer(nodo.hijos[0]);
                    const lista_siempreqs = this.recorrer(nodo.hijos[1]);
                    const inst_siempreqn = this.recorrer(nodo.hijos[2]);
                    return new instruccion_siempreq_1.InstruccionSiempreq(nodo.linea, [inst_siempreq, ...lista_siempreqs, inst_siempreqn]);
            }
        }
        //IF
        if (this.soyNodo('SIEMPREQ', nodo)) {
            //if par_izq EXP par_der llave_izq INSTRUCCIONES llave_der
            const condicion = this.recorrer(nodo.hijos[2]);
            const instrucciones = this.recorrer(nodo.hijos[5]);
            return new siempreq_1.Siempreq(condicion, instrucciones);
        }
        //ELSE
        if (this.soyNodo('SIEMPREQN', nodo)) {
        ...
        //ELSE_IF
        if (this.soyNodo('SIEMPREQN_SIEMPREQ', nodo)) {
        ...
        //LISTA_ELSE_IF
        if (this.soyNodo('LISTA_SIEMPREQN_SIEMPREQ', nodo)) {
            const lista = [];
            nodo.hijos.forEach((nodoHijo) => {
                const resp = this.recorrer(nodoHijo);
                if (resp instanceof siempreq_1.Siempreq) {
                    lista.push(resp);
                }
            });
            return lista;
        ...
        if (this.soyNodo('INCREMENTO_DECREMENTO', nodo)) {
            ...
            const id = nodo.hijos[0];
            const incremento = nodo.hijos[1] == '#incr';
    ...
    puedoEjecutar(nodo) {
        ...
        if (this.soyNodo('INSTRUCCIONES', nodo)) {
            for (let nodoHijo of nodo.hijos) {
                ...
                if (this.soyNodo('DECLARACION_METODO', nodoHijo)) {
            ...
            for (let nodoHijo of nodo.hijos) {
                ...
                if (this.soyNodo('INSTRUCCIONES', nodoHijo)) {
                    for (let nodoInst of nodoHijo.hijos) {
                        if (this.soyNodo('DECLARACION_METODO', nodoInst)) {
                            return false;
                        }
                    }
                }
